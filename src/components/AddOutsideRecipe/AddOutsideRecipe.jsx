...
function AddOutsideRecipe() {
    ...
    if (recipeName === '' || recipeUrl === '') {
      ...
      if (recipePhoto === '') {
        ...
        const recipeToAdd = {
          ...
          name: recipeName,
          photo:
            'https://www.greenbiz.com/sites/default/files/images/articles/featured/fooddisplaysstock.jpg',
  ...
  const fillForm = () => {
    ...
    setRecipePhoto(
      'https://cafedelites.com/wp-content/uploads/2017/12/Garlic-Herb-Butter-Roast-Chicken-1.jpg'
    );
    ...
    <div className="outside-recipe-container">
      <center>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <Typography color="secondary">Tags: {tags}</Typography>
            <br />
            <TextField
              variant="filled"
              label="add Tag"
